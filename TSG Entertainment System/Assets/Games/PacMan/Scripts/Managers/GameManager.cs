...
public class GameManager : MonoBehaviour {
	...
	void Start () 
	{
        ...
        ReadySound = GameObject.Find("StartSound").GetComponent<AudioSource>();
        ReadySound.Play();
    }
    ...
    void OnLevelWasLoaded()
    {
        ...
        pacman.GetComponent<PacManController>().speed += Level*SpeedPerLevel/2;
    }
	...
	public void ResetScene()
	{
		...
		pacman.GetComponent<PacManController>().ResetDestination();
